...
public class StoreBid extends HttpServlet
{
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException
  {
    ...
    SB_StoreBidHome bHome;
    SB_StoreBid storeBid;
    try 
    {
      bHome = (SB_StoreBidHome)PortableRemoteObject.narrow(initialContext.lookup("SB_StoreBidHome"),
    ...
    try
    {
      storeBid = bHome.create();
      storeBid.createBid(userId.intValue(), itemId.intValue(), bid, maxBid, qty);

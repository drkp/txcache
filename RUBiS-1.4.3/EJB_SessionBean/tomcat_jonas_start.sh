...
#CLASSPATH=${JONAS_ROOT}/lib/RMI_client.jar:${JONAS_ROOT}/lib/RMI_jonas.jar:/users/margueri/RUBiS/EJB_SessionBean/rubis.jar

# classpath jonas 2.6/ 3.x jeremie
#CLASSPATH=${JONAS_ROOT}/lib/JEREMIE_client.jar:${JONAS_ROOT}/lib/JEREMIE_jonas.jar:/users/margueri/RUBiS/EJB_SessionBean/rubis.jar

# classpath jonas 3.1 with carol
#CLASSPATH=${JONAS_ROOT}/lib/client.jar:${JONAS_ROOT}/lib/jonas.jar:${JONAS_ROOT}/lib/common/carol/carol.jar:/users/margueri/RUBiS/EJB_SessionBean/rubis.jar

# jonas 2.5
#. $JONAS_ROOT/bin/unix/config_env
#CLASSPATH=${CLASSPATH}:.:/users/margueri/RUBiS/EJB_SessionBean/rubis.jar:/users/margueri/RUBiS/EJB_SessionBean/rubis_ejb_servlets.jar:

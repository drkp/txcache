...
public interface ItemHome extends EJBHome {
   ...
   */
  public Item create(String itemName, String itemDescription, float itemInitialPrice,
   ...
   */
  public Item findByPrimaryKey(ItemPK id) throws FinderException, RemoteException;

...
public class SB_AboutMeBean implements SessionBean 
{
  ...
  public String getAboutMe(String username, String password) throws RemoteException
  {
    ...
    try
    {
      UserLocal u = uHome.findByPrimaryKey(new UserPK(userId));
  ...
  public String listWonItems(Integer userId, ItemLocalHome iHome, QueryLocalHome qHome) throws RemoteException 
  {
  ...
  public String listBids(Integer userId, String username, String password, ItemLocalHome iHome, QueryLocalHome qHome) throws RemoteException 
  {

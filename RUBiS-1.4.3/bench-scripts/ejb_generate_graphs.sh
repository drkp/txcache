...
# $6 is the number of ejb servers

 if [ -d $1 ]; then
   # Generate data files
  for ((i = 0; i < $4; i = i + 1)); do
    gunzip $1db_server$i.gz
    bench-scripts/format_sar_output.awk $1db_server$i
    gzip -9 $1db_server$i &
  done
   gunzip $1"web_server.gz"
   bench-scripts/format_sar_output.awk $1"web_server"
   gzip -9 $1"web_server" &
  for ((i = 0; i < $5; i = i + 1)); do
    gunzip $1servlets_server$i.gz
    bench-scripts/format_sar_output.awk $1servlets_server$i
    gzip -9 $1servlets_server$i &
  done
  for ((i = 0; i < $6; i = i + 1)); do
    gunzip $1ejb_server$i.gz
    bench-scripts/format_sar_output.awk $1ejb_server$i
    gzip -9 $1ejb_server$i &
  done
  for ((i = 0 ; i < $3 ; i = i + 1)); do
     gunzip $1client$i.gz
     bench-scripts/format_sar_output.awk $1client$i
     gzip -9 $1client$i &
  done
  ...
  echo plot '"'$1db_server0.cpu.idle.dat'"' title '"'Database'"' with lines, '"'$1web_server.cpu.idle.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server0.cpu.idle.dat'"' title '"'Servlets'"' with lines , '"'$1ejb_server0.cpu.idle.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  ...
  echo "set yrange [0:100]" >> $tmpFile;
  echo plot '"'$1db_server0.cpu.busy.dat'"' title '"'Database'"' with lines, '"'$1web_server.cpu.busy.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server0.cpu.busy.dat'"' title '"'Servlets'"' with lines, '"'$1ejb_server0.cpu.busy.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server0.proc.dat'"' title '"'Database'"' with lines, '"'$1web_server.proc.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server0.proc.dat'"' title '"'Servlets'"' with lines, '"'$1ejb_server0.proc.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server0.ctxsw.dat'"' title '"'Database'"' with lines, '"'$1web_server.ctxsw.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server0.ctxsw.dat'"' title '"'Servlets'"' with lines, '"'$1ejb_server0.ctxsw.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server0.disk.tps.dat'"' title '"'Database'"' with lines, '"'$1web_server.disk.tps.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server0.disk.tps.dat'"' title '"'Servlets'"' with lines, '"'$1ejb_server0.disk.tps.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server0.disk.rtps.dat'"' title '"'Database read'"' with lines, '"'$1db_server0.disk.wtps.dat'"' title '"'Database write'"' with lines, '"'$1web_server.disk.rtps.dat'"' title '"'Frontend read'"' with lines, '"'$1web_server.disk.wtps.dat'"' title '"'Frontend write'"' with lines, '"'$1servlets_server0.disk.rtps.dat'"' title '"'Servlets read'"' with lines, '"'$1servlets_server0.disk.wtps.dat'"' title '"'Servlets write'"' with lines, '"'$1ejb_server0.disk.rtps.dat'"' title '"'EJB read'"' with lines, '"'$1ejb_server0.disk.wtps.dat'"' title '"'EJB write'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server0.disk.brdps.dat'"' title '"'Database read'"' with lines, '"'$1db_server0.disk.bwrps.dat'"' title '"'Database write'"' with lines, '"'$1web_server.disk.brdps.dat'"' title '"'Frontend read'"' with lines, '"'$1web_server.disk.bwrps.dat'"' title '"'Frontend write'"' with lines, '"'$1servlets_server0.disk.brdps.dat'"' title '"'Servlets read'"' with lines, '"'$1servlets_server0.disk.bwrps.dat'"' title '"'Servlets write'"' with lines, '"'$1ejb_server0.disk.brdps.dat'"' title '"'EJB read'"' with lines, '"'$1ejb_server0.disk.bwrps.dat'"' title '"'EJB write'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server0.mem.kbmemused.dat'"' title '"'Database'"' with lines, '"'$1web_server.mem.kbmemused.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server0.mem.kbmemused.dat'"' title '"'Servlets'"' with lines, '"'$1ejb_server0.mem.kbmemused.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Amount of memory in KB"' >> $tmpFile;
  echo plot '"'$1db_server0.mem.kbmemused.dat'"' title '"'Database memory'"' with lines, '"'$1web_server.mem.kbmemused.dat'"' title '"'Frontend memory'"' with lines, '"'$1servlets_server0.mem.kbmemused.dat'"' title '"'Servlets memory'"' with lines, '"'$1ejb_server0.mem.kbmemused.dat'"' title '"'EJB memory'"' with lines, '"'$1db_server0.mem.kbcached.dat'"' title '"'Database cache'"' with lines, '"'$1web_server.mem.kbcached.dat'"' title '"'Frontend cache'"' with lines, '"'$1servlets_server0.mem.kbcached.dat'"' title '"'Servlets cache'"' with lines, '"'$1ejb_server0.mem.kbcached.dat'"' title '"'EJB cache'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server0.net.rxpck.dat'"' title '"'Database received'"' with lines, '"'$1db_server0.net.txpck.dat'"' title '"'Database transmitted'"' with lines, '"'$1web_server.net.rxpck.dat'"' title '"'Frontend received'"' with lines, '"'$1web_server.net.txpck.dat'"' title '"'Frontend transmitted'"' with lines, '"'$1servlets_server0.net.rxpck.dat'"' title '"'Servlets received'"' with lines, '"'$1servlets_server0.net.txpck.dat'"' title '"'Servlets transmitted'"' with lines, '"'$1ejb_server0.net.rxpck.dat'"' title '"'EJB received'"' with lines, '"'$1ejb_server0.net.txpck.dat'"' title '"'EJB transmitted'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server0.net.rxbyt.dat'"' title '"'Database received'"' with lines, '"'$1db_server0.net.txbyt.dat'"' title '"'Database transmitted'"' with lines, '"'$1web_server.net.rxbyt.dat'"' title '"'Frontend received'"' with lines, '"'$1web_server.net.txbyt.dat'"' title '"'Frontend transmitted'"' with lines, '"'$1servlets_server0.net.rxbyt.dat'"' title '"'Servlets received'"' with lines, '"'$1servlets_server0.net.txbyt.dat'"' title '"'Servlets transmitted'"' with lines, '"'$1ejb_server0.net.rxbyt.dat'"' title '"'EJB received'"' with lines, '"'$1ejb_server0.net.txbyt.dat'"' title '"'EJB transmitted'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
  ...
  echo plot '"'$1db_server0.sock.totsck.dat'"' title '"'Database'"' with lines, '"'$1web_server.sock.totsck.dat'"' title '"'Frontend'"' with lines, '"'$1servlets_server0.sock.totsck.dat'"' title '"'Servlets'"' with lines, '"'$1ejb_server0.sock.totsck.dat'"' title '"'EJB'"' with lines >> $tmpFile;
  /usr/bin/gnuplot $tmpFile
 ...
 echo 'set title "Memory & cache usage"' >> $tmpFile;
  ...
  # Plot CPU idle time
  echo "Generating EJB CPU idle time graph";
  echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_cpu_idle.$2'"' >> $tmpFile;
  echo 'set title "Processor idle time"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Processor idle time in %"' >> $tmpFile;
  echo "set yrange [0:100]" >> $tmpFile;
  echo -n plot '"'$1ejb_server0.cpu.idle.dat'"' title '"'EJB 0'"' with lines >> $tmpFile;
  for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.cpu.idle.dat'"' title '"'EJB $i'"' with lines >> $tmpFile;
  done
  /usr/bin/gnuplot $tmpFile
  # Plot CPU busy time 
  echo "Generating EJB CPU busy time graph";
  echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_cpu_busy.$2'"' >> $tmpFile;
  echo 'set title "Processor usage"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Processor usage in %"' >> $tmpFile;
  echo "set yrange [0:100]" >> $tmpFile;
  echo -n plot '"'$1ejb_server0.cpu.busy.dat'"' title '"'EJB 0'"' with lines >> $tmpFile;
  for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.cpu.busy.dat'"' title '"'EJB $i'"' with lines >> $tmpFile;
  done
  /usr/bin/gnuplot $tmpFile

  # Plot CPU user/system time
  echo "Generating EJB CPU user/system time graph";
  echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_cpu_user_kernel.$2'"' >> $tmpFile;
  echo 'set title "User/Kernel processor usage"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Processor usage in %"' >> $tmpFile;
  echo "set yrange [0:100]" >> $tmpFile;
  echo -n plot '"'$1ejb_server0.cpu.user.dat'"' title '"'EJB 0 user'"' with lines, '"'$1ejb_server0.cpu.system.dat'"' title '"'EJB 0 kernel'"' with lines >> $tmpFile;
  for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.cpu.user.dat'"' title '"'EJB $i user'"' with lines', "'$1ejb_server$i.cpu.system.dat'"' title '"'EJB $i system'"' with lines >> $tmpFile;
  done
  /usr/bin/gnuplot $tmpFile

  # Plot Processes/second
  echo "Generating EJB Processes/second graph";
  echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_procs.$2'"' >> $tmpFile;
  echo 'set title "Processes created"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Nb of processes created per second"' >> $tmpFile;
  echo -n plot '"'$1ejb_server0.proc.dat'"' title '"'EJB 0'"' with lines >> $tmpFile;
  for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.proc.dat'"' title '"'EJB $i'"' with lines >> $tmpFile;
  done
  /usr/bin/gnuplot $tmpFile

  # Plot Context switches/second
  echo "Generating EJB Context switches/second graph";
  echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_ctxtsw.$2'"' >> $tmpFile;
  echo 'set title "Context switches"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Nb of context switches per second"' >> $tmpFile;
  echo -n plot '"'$1ejb_server0.ctxsw.dat'"' title '"'EJB 0'"' with lines >> $tmpFile;
  for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.ctxsw.dat'"' title '"'EJB $i'"' with lines >> $tmpFile;
  done
  /usr/bin/gnuplot $tmpFile

  # Plot Disk total transfers
  echo "Generating EJB Disk total transfers graph";
  echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_disk_tps.$2'"' >> $tmpFile;
  echo 'set title "Disk transfers"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Nb of disk transfers per second"' >> $tmpFile;
  echo -n plot '"'$1ejb_server0.disk.tps.dat'"' title '"'EJB 0'"' with lines >> $tmpFile;
  for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.disk.tps.dat'"' title '"'EJB $i'"' with lines >> $tmpFile;
  done
  /usr/bin/gnuplot $tmpFile

  # Plot disk read/write requests
  echo "Generating EJB disk read/write requests graph";
  echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_disk_rw_req.$2'"' >> $tmpFile;
  echo 'set title "Read/Write disk requests"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Nb of requests per second"' >> $tmpFile;
  echo -n plot '"'$1ejb_server0.disk.rtps.dat'"' title '"'EJB 0 read'"' with lines, '"'$1ejb_server0.disk.wtps.dat'"' title '"'EJB 0 write'"' with lines >> $tmpFile;
  for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.disk.rtps.dat'"' title '"'EJB $i read'"' with lines', "'$1ejb_server$i.disk.wtps.dat'"' title '"'EJB $i write'"' with lines >> $tmpFile;
  done
  /usr/bin/gnuplot $tmpFile

  # Plot disk blocks read/write requests
  echo "Generating EJB disk blocks read/write requests graph";
  echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_disk_rw_req.$2'"' >> $tmpFile;
  echo 'set title " Disk blocks read/write requests"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Nb of blocks per second"' >> $tmpFile;
  echo -n plot '"'$1ejb_server0.disk.brdps.dat'"' title '"'EJB 0 read'"' with lines, '"'$1ejb_server0.disk.bwrps.dat'"' title '"'EJB 0 write'"' with lines >> $tmpFile;
  for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.disk.brdps.dat'"' title '"'EJB $i read'"' with lines', "'$1ejb_server$i.disk.bwrps.dat'"' title '"'EJB $i write'"' with lines >> $tmpFile;
  done
  /usr/bin/gnuplot $tmpFile

  # Plot Memory usage
  echo "Generating EJB Memory usage graph";
 echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_mem_usage.$2'"' >> $tmpFile;
  echo 'set title "Memory usage"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Amount of memory in KB"' >> $tmpFile;
  echo -n plot '"'$1ejb_server0.mem.kbmemused.dat'"' title '"'EJB 0'"' with lines >> $tmpFile;
  for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.mem.kbmemused.dat'"' title '"'EJB $i'"' with lines >> $tmpFile;
  done
  /usr/bin/gnuplot $tmpFile

  # Plot Memory & cache usage
  echo "Generating EJB Memory & cache usage graph";
  echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_mem_cache.$2'"' >> $tmpFile;
  echo 'set title "Memory & cache usage"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Amount of memory in KB"' >> $tmpFile;
  echo -n plot '"'$1ejb_server0.mem.kbmemused.dat'"' title '"'EJB 0 memory'"' with lines, '"'$1ejb_server0.mem.kbcached.dat'"' title '"'EJB 0 cache'"' with lines >> $tmpFile;
 for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.mem.kbmemused.dat'"' title '"'EJB $i memory'"' with lines', "'$1ejb_server$i.mem.kbcached.dat'"' title '"'EJB $i cache'"' with lines >> $tmpFile;
  done
  /usr/bin/gnuplot $tmpFile

  # Plot network received/transmitted packets
  echo "Generating EJB network received/transmitted packets graph";
  echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_net_rt_pack.$2'"' >> $tmpFile;
  echo 'set title "Network received/transmitted packets"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Nb of packets per second"' >> $tmpFile;
  echo -n plot '"'$1ejb_server0.net.rxpck.dat'"' title '"'EJB 0 received'"' with lines, '"'$1ejb_server0.net.txpck.dat'"' title '"'EJB 0 transmitted'"' with lines >> $tmpFile;
  for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.net.rxpck.dat'"' title '"'EJB $i received'"' with lines', "'$1ejb_server$i.net.txpck.dat'"' title '"'EJB $i transmitted'"' with lines >> $tmpFile;
  done
  /usr/bin/gnuplot $tmpFile
  # Plot network received/transmitted bytes
  echo "Generating EJB network received/transmitted bytes graph";
  echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_net_rt_byt.$2'"' >> $tmpFile;
  echo 'set title "Network received/transmitted bytes"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Nb of bytes per second"' >> $tmpFile;
  echo -n plot '"'$1ejb_server0.net.rxbyt.dat'"' title '"'EJB 0 received'"' with lines, '"'$1ejb_server0.net.txbyt.dat'"' title '"'EJB 0 transmitted'"' with lines >> $tmpFile;
  for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.net.rxbyt.dat'"' title '"'EJB $i received'"' with lines', "'$1ejb_server$i.net.txbyt.dat'"' title '"'EJB $i transmitted'"' with lines >> $tmpFile;
  done
 /usr/bin/gnuplot $tmpFile

  # Plot Sockets usage
  echo "Generating EJB Sockets usage graph";
  echo "set terminal "$2 > $tmpFile;
  echo set output '"'$1ejb_socks.$2'"' >> $tmpFile;
  echo 'set title "Sockets"' >> $tmpFile;
  echo 'set xlabel "Time in seconds"' >> $tmpFile;
  echo 'set ylabel "Number of sockets"' >> $tmpFile;
  echo -n plot '"'$1ejb_server0.sock.totsck.dat'"' title '"'EJB 0'"' with lines >> $tmpFile;
  for ((i = 1 ; i < $6 ; i = i + 1)); do
    echo -n ', "'$1ejb_server$i.sock.totsck.dat'"' title '"'EJB $i'"' with lines >> $tmpFile;
  done
  /usr/bin/gnuplot $tmpFile

...
static TupleTableSlot *SeqNext(SeqScanState *node, bool timeQual);
...
SeqNext(SeqScanState *node, bool timeQual)
{
	HeapTuple	tuple;
	 ...
	 */
	tuple = heap_getnext_im(scandesc, direction,
							estate->es_xstamp, &inv, timeQual);
...
ExecSeqScan(SeqScanState *node)
{
	 ...
	 */
	return ExecScan((ScanState *) node, (ExecScanAccessMtd) SeqNext, true);
}

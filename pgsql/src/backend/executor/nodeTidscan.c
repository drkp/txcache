...
static TupleTableSlot *TidNext(TidScanState *node, bool timeQual);
...
TidNext(TidScanState *node, bool timeQual)
{
	EState	   *estate;
...
ExecTidScan(TidScanState *node)
{
	 ...
	 */
	return ExecScan(&node->ss, (ExecScanAccessMtd) TidNext, false);
}

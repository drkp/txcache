...
typedef struct TupleTableSlot
{
	...
	ValidityInterval tts_valint; /* for non-physical tuples */
} TupleTableSlot;
...
extern ValidityInterval GetHeapTupleValidity(HeapTuple tuple);
extern ValidityInterval GetTupleValidity(TupleTableSlot *slot);

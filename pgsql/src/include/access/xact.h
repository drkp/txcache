...
extern bool XactWrote;
extern bool XactInvalidated;
...
extern XStamp AssignAndPinTransactionSnapshot(struct timeval *tp);
extern void SetTransactionXStamp(XStamp xstamp);
extern XStamp GetTransactionXStamp();
extern XStamp GetLatestXStampAtTransactionStart();
extern void SetLatestXStampAtTransactionStartIfUnset(XStamp xstamp);

...
{
	HeapTupleVisible,
	HeapTupleNotInsertedYet,
	HeapTupleAlreadyDeleted,
	HeapTupleCurrentTransaction,
	HeapTupleInvalid
} HTSS_Reason;

extern HTSS_Reason LastHTSSReason;
...
extern bool XidInSnapshot(TransactionId xid, Snapshot snapshot);

extern Snapshot GetTransactionSnapshot(void);
extern bool TransactionHasSerializableSnapshot(void);
extern Snapshot GetLatestSnapshot(void);
extern void SetSerializableSnapshot(Snapshot snap);
